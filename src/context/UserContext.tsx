  ...
  const addDeposit = useCallback(async (payload: DepositState) => {
    if (payload) {
      try {
        ...
        await toast.promise(
          updateDoc(addDepositRef, { deposits: arrayUnion(payload) }),
          {
  ...
  const addWithdrawal = async (payload: WithdrawalState) => {
    if (payload) {
      try {
        ...
        await toast.promise(
          updateDoc(addWithdrawalRef, { withdrawals: arrayUnion(payload) }),
          {
  ...
  const addTrade = async (payload: TradeState) => {
    if (payload) {
      try {
        ...
        await toast.promise(
          updateDoc(addTradeRef, { trades: arrayUnion(payload) }),
          {
