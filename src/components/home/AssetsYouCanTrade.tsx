	...
	return (
		<section className="max-w-7xl mx-auto my-24 px-6">
			...
			<h2 className="lg:max-w-[60%] mx-auto leading-7 text-lg text-center mb-10">
				Cryptocrest Trade Insights lets you diversify your portfolio by investing in a global
				selection of stocks, ETFs, Futures, carefully screened and curated into portfolios just for
				you. Trade more than 600 products including Forex, Share CFDs, Commodities, Indices, and
				Metals.
			</h2>
...
function TradingOptionsCard({ img, title, description, url }: TradingOptionsCardProps) {
	return (
		<Link to={url} className="flex flex-col items-center justify-center text-center">
