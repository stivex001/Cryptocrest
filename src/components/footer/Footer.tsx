...
import footerLogo from "../../images/crest-logo.svg";
...
export default function Footer() {
	...
	return (
		<>
			<footer className="bg-slate-200 text-black py-16 20 px-6 xl:px-0">
					...
					<div className="lg:flex justify-between">
						<div className="w-full lg:w-[47%]">
							...
							<div className="flex items-center gap-5 pb-10 text-xl ">
								<div className="flex items-center justify-center rounded-[50%] h-10 w-10 bg-blue">
							...
							<div>
								<p className="w-full lg:w-[60%]">
									...
									CryptoCrest. All rights reserved. <br /> <br />© 2024 CryptoCrest (MU).
								</p>
							</div>
						</div>
