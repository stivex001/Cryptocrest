...
const faq2 = [
  ...
  {
    id: 2,
    title: "How to trade cryptocurrencies with CMC Markets",
    content:
  ...
  {
    id: 3,
    title: "What are the costs involved in trading on cryptocurrencies?",
    content:
...
export const CryptoFaq = (props: Props) => {
  return (
