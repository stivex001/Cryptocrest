				...
				>
					<form onSubmit={handleSubmit}>
						<div className="mb-5 mt-10">
							<label className="mb-2.5 block font-medium text-black">Notification Title:</label>
						...
						<div className="mb-5 ">
							<label className="mb-2.5 block font-medium text-black">Notification Message:</label>
							<div className="relative">
								<input
									type="text"
									name="message"
							...
							<tbody>
								{paginatedUsers?.map((userItem: any, key: number) => (
									<tr key={key}>
										...
										<td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
											<h5 className="font-medium text-black dark:text-white">{userItem.message}</h5>
										</td>
